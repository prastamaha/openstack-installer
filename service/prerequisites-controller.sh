...
[mysqld]
bind-address = $CONTROLLER_PROVIDER_IP
...
MAXCONN="1024"
CACHESIZE="64"
OPTIONS="-l 127.0.0.1,::1,$CONTROLLER_PROVIDER_IP"
...
ETCD_LISTEN_PEER_URLS="http://$CONTROLLER_PROVIDER_IP:2380"
ETCD_LISTEN_CLIENT_URLS="http://$CONTROLLER_PROVIDER_IP:2379"
ETCD_NAME="controller"

[Clustering]
ETCD_INITIAL_ADVERTISE_PEER_URLS="http://$CONTROLLER_PROVIDER_IP:2380"
ETCD_ADVERTISE_CLIENT_URLS="http://$CONTROLLER_PROVIDER_IP:2379"
ETCD_INITIAL_CLUSTER="controller=http://$CONTROLLER_PROVIDER_IP:2380"
